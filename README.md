...
# Instagram Restaurant Bookmarker

A Python tool that takes Instagram post URLs, extracts restaurant names and locations using AI, finds them on Google Maps, and saves them to an interactive map you can explore in your browser.
...
- Google Places API requires billing to be enabled (but has a generous free tier)
